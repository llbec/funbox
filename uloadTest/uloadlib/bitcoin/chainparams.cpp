...
// macro used to generate genesis
...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime,uint256  nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward,  const vuc &solution)
{
    ...
    genesis.nSolution = solution;
    return genesis;
}

static CBlock CreateGenesisBlock(uint32_t nTime, uint256  nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward,const vuc &solution)
{
    const char *pszTimestamp = "Frustrated and Defiant, Trump Reshapes U.S. Immigration. 12/24/2017 @ 1:51am (UTC)";
    const CScript genesisOutputScript = CScript() << ParseHex("040a70ee17d16b202b7087e059ad63"
                              "94b618a1982cf14a90f927f388154a83580fe195733f5d0141440a88d0e9"
							  "be1df348456fb652a705d4bea2637c"
							  "bbfb622c2d")<< OP_CHECKSIG;

    return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nNonce, nBits, nVersion, genesisReward, solution);
}
