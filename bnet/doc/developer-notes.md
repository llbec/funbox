...
Bnet Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Bnet Core, where everyone uses
...
pay attention to for reviewers of Bnet Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Bnet Core uses tinyformat, which is type safe. Leave them out to avoid confusion
