...
Only requiring some minor changes is bnet.cpp.
...
Changes to bnet.cpp
----------------------
bnet.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
