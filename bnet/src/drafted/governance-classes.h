 ...
 *
 *   // network
 *   CBnetNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bnet.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBnetNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BnetNetwork
// //   -- signature requirements : Key1(User)
// class CBnetNetworkVariable : public CGovernanceObject
// {
// private:
