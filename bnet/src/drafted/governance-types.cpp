...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BnetNetwork") type = BnetNetwork;
    if(strType == "BnetNetworkVariable") type = BnetNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BnetNetwork) s = "BnetNetwork";
    if(type == BnetNetworkVariable) s = "BnetNetworkVariable";
