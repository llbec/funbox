    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bnet Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bnet address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bnet: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bnet Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bnet Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bnet Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bnet addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bnet addresses"));
    ...
    openAction->setStatusTip(tr("Open a bnet: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bnet Core help message to get a list with possible Bnet Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bnet Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bnet network", "", count));
}
...
{
    QString strTitle = tr("Bnet Core"); // default title
