    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bnet Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bnet Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bnet-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bnet in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 BNC, 1 BNC, 10 BNC, and 100 BNC--sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bnetpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://bnetpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bnet Core is shutting down...") + "<br /><br />" +
