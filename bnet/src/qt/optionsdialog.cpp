    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BNC-light"), QVariant("light"));
    ui->theme->addItem(QString("BNC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BNC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BNC-traditional"), QVariant("trad"));
